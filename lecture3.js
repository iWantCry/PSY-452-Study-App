const lecture3Notes = [
    {
        type: "exam-focus",
        content: `
            <h3>Evolutionary Psychology: Guiding Ideas</h3>
            <p><strong>Basic Premise:</strong> The brain is shaped by biological selection pressures. One needs to survive (nutrition, avoiding predators/disease, managing relationships) to reproduce successfully. Prejudices, stereotyping, and discrimination reflect evolved adaptations.</p>
            <ul>
    ...
    },
    {
        type: "exam-focus",
        content: `
            <h3>Affordance-Management Systems</h3>
            <ul>
            ...
            <ul>
                <li><span class="highlight-tag">Intersection of Important Features:</span> The most prominent stereotypes exist at the intersections of important primary categories (e.g., sex/age, not just sex alone).
                    <ul>
                        <li><em>Example:</em> Men are viewed as more competitive when they are younger. The intersection provides the affordance (i.e., how to react/interact).</li>
                    </ul>
                </li>
                <li><span class="highlight-tag">Target and Intended Behaviors:</span> Stereotypes include anticipated behaviors directed <em>toward us</em> rather than behavior in general. Our stereotypes map the target of the stereotypical behavior.
                    <ul>
                        <li><em>Example:</em> Men are stereotyped as competitive, but specifically competitive <em>towards other males</em>.</li>
                        <li><em>Example:</em> Infantilization of the elderly occurs in anticipation of their clumsiness affecting us.</li>
                    </ul>
                </li>
                <li><span class="highlight-tag">Ecology and Coalitions:</span> Race is a challenge for the evolutionary perspective due to relatively recent historical contact. It is better explained via:
                    <ul>
                        <li><em>Life History Theory:</em> Fast (impulsive, present-focused, dangerous ecology) vs. Slow (future-focused, stable ecology) strategies. Race may be used as a heuristic cue for ecology.</li>
                        <li><em>Coalitional Membership:</em> Race acts as a cue for cooperative alliances. If true coalitional membership is explicitly known, people are less likely to categorize by race.</li>
                    </ul>
                </li>
            </ul>
        `
    },
    {
        type: "standard-notes",
        content: `
            <h3>Supporting Evidence: Vulnerability & Threat Perception</h3>
            <h4>Cottrell (2005) & Emotional Responses</h4>
            <ul>
            ...
            <ul>
                ...
                <li><em>Schaller et al. (2003):</em> Being in a dark room (increasing vulnerability) leads participants with a high "Belief in a Dangerous World" to heavily activate danger-relevant stereotypes regarding Black individuals.</li>
                <li><em>McDonald et al. (2015):</em> Women at a high conception risk who feel highly vulnerable to sexual coercion are significantly less willing to accept a date request from an outgroup male compared to an ingroup male.</li>
                <li><em>Rodeheffer et al. (2012):</em> When primed with economic scarcity (insecurity), white participants were significantly more likely to categorize ambiguous faces as Black rather than White.</li>
            </ul>
        `
    },
    {
        type: "standard-notes",
        content: `
            <h3>The Behavioral Immune System</h3>
            <ul>
                <li>An affordance-management system designed to minimize infection risk by changing cognition, affect, and behavior to promote pathogen avoidance.</li>
            ...
            <ul>
                ...
                <li><em>Park (2007):</em> Heightening pathogen salience directly increased the implicit association linking "fat people" to "disease" in an IAT task.</li>
                <li><em>Faulkner (2003):</em> Pathogen salience significantly decreased the budget participants were willing to allocate to attract immigrants from "foreign" countries, while having little effect on "familiar" immigrants.</li>
            </ul>
        `
    },
    {
        type: "standard-notes",
        content: `
            <h3>Coalitions & The "Who Said What" Paradigm</h3>
            <h4>Sub-typing and Categorization</h4>
            <ul>
            ...
            <ul>
                ...
                <li>However, within-sex errors remained high regardless of coalition information. This proves that while race acts dynamically as a proxy for an alliance category, gender is a fundamental, structurally hard-coded category across all contexts.</li>
            </ul>
        `
    }
];