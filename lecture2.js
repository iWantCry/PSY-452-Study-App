var lecture2Notes = [
    ...
    },
    {
        type: "standard-notes",
        content: `
            <h3>Contextual Ingroup Dynamics</h3>
            <p><strong>Dynamic Shifting:</strong> Ingroup identification depends on current motives, fears, goals, and expectations.</p>
            <ul>
                <li><em>Everyday Shifts:</em> Your active ingroup shifts throughout the day based on context (e.g., relating to pedestrians versus e-scooter users while walking).</li>
                <li><em>Saliency:</em> During an election cycle, political party identification becomes a highly salient ingroup.</li>
            </ul>
        `
    },
    {
        type: "exam-focus",
        content: `
            <h3>Group Distinctions & Bias Types</h3>
            <h4>Heterogeneity & Homogeneity</h4>
            <ul>
    ...
    },
    {
        ...
        content: `
            ...
            <ul>
                ...
                <li>Participants were asked to either <span class="highlight-tag">Describe</span> (assume/retrieve general trait) or <span class="highlight-tag">Define</span> (no example retrieval).</li>
                <li><em>Results:</em> Participants had faster recall response times for positive IG behaviors and negative OG behaviors in the <em>describe</em> condition, reflecting a prior automatic reply that required no specific memory search to confirm.</li>
            </ul>
        `
    },
    {
        type: "standard-notes",
        content: `
            <h3>Deep Dive: Experimental Bias Influences</h3>
            <h4>Perdue et al. (1990)</h4>
            <ul>
                <li>Demonstrated that IG bias occurs across all levels of processing (shallow to deep).</li>
            ...
            <ul>
                ...
                <li>Reaction time was fastest when "WHITE" was paired with positive words (demonstrating IG bias), but there was an absence of outgroup negativity (no significant difference when paired with negative words).</li>
            </ul>
        `
    },
    {
        type: "exam-focus",
        content: `
            <h3>Influences on Perception & Prosocial Behaviors</h3>
            <h4>Perception & Facial Processing</h4>
            <ul>
                <li><span class="highlight-tag">Recognition Bias:</span> Individuals are more likely to identify faces from their ingroup than the outgroup.</li>
            ...
            <ul>
                ...
                <li><em>Context & Distance:</em> People are highly likely to help when there is immediate contact and visible ethnicity matching, but helping drops significantly (to roughly 25%) in distant contexts (e.g., over the telephone).</li>
                <li><em>Presence of Others:</em> The presence of bystanders creates a large ethnicity effect where people tend to only help those of their own ethnicity.</li>
                <li><em>Dictator Game:</em> Demonstrates that people are willing to incur personal costs to help IG members, but very few will actively choose to inflict losses on the OG.</li>
            </ul>
        `
    },
    {
        type: "standard-notes",
        content: `
            <h3>Justice, Attributions & Overcoming Bias</h3>
            <h4>Attributions & Fairness</h4>
            <ul>
            ...
            <ul>
                ...
                <li><span class="highlight-tag">Recategorization:</span> Changing the perception of the IG to create more inclusive boundaries (e.g., framing everyone as "company workers" or "academics").</li>
                <li><span class="highlight-tag">Cross-categorization:</span> Finding separate, shared identities (e.g., discovering an OG member is also a parent or a dog-owner).</li>
            </ul>
        `
    },
    {
        type: "exam-focus",
        content: `
            <h3>Invisible Discrimination & Boosting</h3>
            <h4>Invisible Discrimination</h4>
            <ul>
            ...
            <ul>
                ...
                <li>When an individual is confronted with an unavoidable personal connection to a negative other, they will elevate aspects of that other's character to protect their own self-image.</li>
                <li><em>Example:</em> Subjects who were told they shared a birth date with the maligned historical figure Rasputin significantly softened their views of his negativity, even though no one else knew of the connection.</li>
            </ul>
        `
    }
];
